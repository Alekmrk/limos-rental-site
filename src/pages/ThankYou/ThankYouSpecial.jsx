...
const ThankYouSpecial = ({ scrollUp }) => {
  ...
  useEffect(() => {
    console.log('ThankYouSpecial component loaded');
              ...
              <div className="bg-royal-blue/5 backdrop-blur-sm p-4 lg:p-6 rounded-lg border border-royal-blue/20">
                ...
                <div className="space-y-2 text-gray-700">
                  ...
                  {dataToShow.referenceNumber && (
                    <>
                      <p className="mt-4 text-sm text-gray-600">Reference Information:</p>
...
export default ThankYouSpecial;
