    ...
    <div className="container-default mt-28">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-5xl md:text-7xl font-semibold mb-8 text-center text-gray-700">
          <span className="text-royal-blue">Terms of Service</span>
        </h1>
        ...
        <div className="bg-cream-light/90 p-8 rounded-lg border border-royal-blue/20 shadow-lg">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-royal-blue mb-4">3. Booking and Reservations</h2>
            <div className="text-gray-600 space-y-4">
              <h3 className="text-xl font-medium text-gray-700 mb-3">3.1 Booking Requirements</h3>
              <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <h3 className="text-xl font-medium text-gray-700 mb-3">3.2 Booking Confirmation</h3>
              <p>
          ...
          {/* Payment Terms */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-royal-blue mb-4">4. Payment Terms</h2>
            <div className="text-gray-600 space-y-4">
              <h3 className="text-xl font-medium text-gray-700 mb-3">4.1 Payment Methods</h3>
              <p>We accept the following payment methods:</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Credit cards (Visa, Mastercard, etc...)</li>
              </ul>
              
              <h3 className="text-xl font-medium text-gray-700 mb-3">4.2 Pricing</h3>
              <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <h3 className="text-xl font-medium text-gray-700 mb-3">4.3 Payment Processing</h3>
              <p>
          ...
          {/* Cancellation Policy */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-royal-blue mb-4">5. Cancellation and Modification Policy</h2>
            <div className="text-gray-600 space-y-4">
              <h3 className="text-xl font-medium text-gray-700 mb-3">5.1 Cancellation by Customer</h3>
              <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <h3 className="text-xl font-medium text-gray-700 mb-3">5.2 Modifications</h3>
              <p>
          ...
          {/* Service Conditions */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-royal-blue mb-4">6. Service Conditions</h2>
            <div className="text-gray-600 space-y-4">
              <h3 className="text-xl font-medium text-gray-700 mb-3">6.1 Passenger Responsibilities</h3>
              <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <h3 className="text-xl font-medium text-gray-700 mb-3">6.2 Baggage and Luggage Policy</h3>
              ...
              <h3 className="text-xl font-medium text-gray-700 mb-3">6.3 Additional Equipment and Services</h3>
              <div className="text-gray-600 space-y-3">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-royal-blue mb-4">7. Liability and Insurance</h2>
            <div className="text-gray-600 space-y-4">
              <h3 className="text-xl font-medium text-gray-700 mb-3">7.1 Insurance Coverage</h3>
              <p>
              ...
              <h3 className="text-xl font-medium text-gray-700 mb-3">7.2 Limitation of Liability</h3>
              <p>
              ...
              <h3 className="text-xl font-medium text-gray-700 mb-3">7.3 Passenger Liability</h3>
              <p>
          ...
          {/* Data Protection */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-royal-blue mb-4">8. Data Protection and Privacy</h2>
            <div className="text-gray-600 space-y-4">
              <p>
          ...
          {/* Dispute Resolution */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-royal-blue mb-4">9. Dispute Resolution</h2>
            <div className="text-gray-600 space-y-4">
              <h3 className="text-xl font-medium text-gray-700 mb-3">9.1 Governing Law</h3>
              <p>
              ...
              <h3 className="text-xl font-medium text-gray-700 mb-3">9.2 Dispute Resolution Process</h3>
          ...
          {/* Changes to Terms */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-royal-blue mb-4">10. Changes to Terms</h2>
            <div className="text-gray-600 space-y-4">
              <p>
          ...
          {/* Contact Information */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-royal-blue mb-4">11. Contact Information</h2>
            <div className="text-gray-600 space-y-4">
          ...
          {/* Effective Date */}
          <section>
            <div className="bg-royal-blue/10 p-4 rounded-lg border border-royal-blue/30">
