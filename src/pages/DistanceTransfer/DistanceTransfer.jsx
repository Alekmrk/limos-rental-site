...
import { faRoute, faMapMarkedAlt, faClock, faShieldAlt, faCalculator, faUsers, faGlobeEurope, faStar } from "@fortawesome/free-solid-svg-icons";
    ...
    <div className="min-h-screen">
      <div className="relative">
        ...
        <div 
          ...
          style={{
            backgroundImage: `linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.4)), url(${distanceTransferImage})`,
          }}
        >
